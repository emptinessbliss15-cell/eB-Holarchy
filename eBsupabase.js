...
export function createEBSupabase()
{
  ...
  return {
    ...
    discussions: {
      ...
      subscribe(callback) { return supabase.channel(`discussion-messages-${crypto.randomUUID()}`).on('postgres_changes', { event: '*', schema: 'public', table: 'discussion_messages' }, callback).subscribe(); },
